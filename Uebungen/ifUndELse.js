...
if(c3 == d3){
    console.log ("Der Wert von c3 und d3 ist gleich")
}else{
    console.log ("Der Wert c3 und d3 ist nicht gleich")
}
...
// Erkenntnisgewinn: Wenn der Audruck (hier: lebensmittel) true oder false ist,
...
if(einzahlung - auszahlung){
    console.log("Der Saldo nicht null")
}else{
